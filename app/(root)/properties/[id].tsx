...
import { getPropertyById } from "@/core/appwrite";
		...
		<View>
			...
			>
				...
				<View className="px-5 mt-7 flex gap-2">
					...
					<View className="flex flex-row items-center gap-3">
						<View className="flex flex-row items-center px-4 py-2 bg-primary-100 rounded-l-full">
					...
					<View className="flex flex-row items-center mt-5">
						...
						<View className="flex flex-row items-center justify-center bg-primary-100 rounded-l-full size-10  ml-7">
						...
						<View className="flex flex-row items-center justify-between mt-4">
							<View className="flex flex-row justify-between">
								...
								<View className="flex flex-col justify-center ml-3">
									<Text className="text-lg text-black-200 text-start font-rubik-medium">
										{property?.agent.name || "Agent Name"}
									</Text>
									<Text className="text-sm text-blue-200 text-start font-rubik-medium">
